        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{url('/datosCporPagar/'.$datosCxP->id)}}" method="post">
                    ...
                    <input type="text" name="claveprodserv" id="claveprodserv" class="form-control"  value="{{$datosCxP->claveProdServ}}">
                    <h5 for="">Numero de Identificacion</h5>
                    <input type="text" name="noIdentificacion" id="noIdentificacion" class="form-control"  value="{{$datosCxP->noIdentificacion}}">
                    <h5 for="">Cantidad</h5>
                    <input type="text" name="cantidad" id="cantidad" class="form-control"  value="{{$datosCxP->cantidad}}">
                    <h5 for="">Clave Unidad</h5>
                    <input type="text" name="claveUnidad" id="claveUnidad" class="form-control"  value="{{$datosCxP->claveUnidad}}">
                    <h5 for="">Unidad</h5>
                    <input type="text" name="unidad" id="unidad" class="form-control"  value="{{$datosCxP->unidad}}">
                    <h5 for="">Descripcion</h5>
                    <input type="text" name="descripcion" id="descripcion" class="form-control"  value="{{$datosCxP->descripcion}}">
                    <h5 for="">Valor unitario</h5>
                    <input type="text" name="valorUnitario" id="valorUnitario" class="form-control"  value="{{$datosCxP->valorUnitario}}">
                    <h5 for="">Importe</h5>
                    <input type="text" name="importe" id="importe" class="form-control"  value="{{$datosCxP->importe}}">
                    <h5 for="">Traslado de Iva (Porsentaje)</h5>
                    <input type="text" name="tivaCxP" id="tivaCxP" class="form-control"  value="{{$datosCxP->tivaCxP}}">
                    <h5 for="">Traslado de Irs (Porcentaje)</h5>
                    <input type="text" name="tisrCxP" id="tisrCxP" class="form-control"  value="{{$datosCxP->tisrCxP}}">
                    <h5 for="">Retencion de Iva (Porcentaje)</h5>
                    <input type="text" name="rivaCxP" id="rivaCxP" class="form-control" value="{{$datosCxP->rivaCxP}}">
                    <h5 for="">Retencion de Isr (Porcentaje)</h5>
                    <input type="text" name="risrCxP" id="risrCxP" class="form-control" value="{{$datosCxP->risrCxP}}">
